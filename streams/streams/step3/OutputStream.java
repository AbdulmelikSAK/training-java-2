...
public class OutputStream {
  ...
  /**
   * Constructs an output stream <br>
   * with an initial capacity of the given number of bytes.
   * 
   * @param nbytes
   *          is the initial capacity in bytes
   */
  ...
  /**
   * @return the current size of this ouput stream, <br>
