...
/*
 * This code is borrowed from the JDK1.8 open source,
 * originally from the Apache Xerces project.
 * We did not remote any copyright notice from 
 * the file, there was none.
 */
...
public class UTF8Reader extends Reader {
  ...
  /**
   * Constructs a UTF-8 reader from the specified input stream, buffer size and
   * MessageFormatter.
   *
   * @param inputStream
   *          The input stream.
   ...
   */
  public UTF8Reader(InputStream inputStream, int size, Locale locale) {
    fInputStream = inputStream;
    fBuffer = new byte[size];
    fLocale = locale;
  }
  public UTF8Reader(InputStream inputStream) {
    this(inputStream,256,Locale.getDefault());
  }
  ...
  public void mark(int readAheadLimit) throws IOException {
    throw new IOException("OperationNotSupported: mark(), UTF-8");
  }
  ...
  private void expectedByte(int position, int count) throws IOException {
    throw new IOException("ExpectedByte " + Integer.toString(position) + " " + Integer.toString(count));
  }

  /** Throws an exception for invalid byte. */
  private void invalidByte(int position, int count, int c) throws IOException {
    throw new IOException("InvalidByte " + Integer.toString(position) + " " + Integer.toString(count));
  }

  /** Throws an exception for invalid surrogate bits. */
  private void invalidSurrogate(int uuuuu) throws IOException {
    throw new IOException("InvalidSurrogate " + Integer.toHexString(uuuuu));
